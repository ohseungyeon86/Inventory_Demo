...
Namespace UIForm
    ...
    <ToolboxBitmap(GetType(AccessLogin), "AccessLogin.ico"), ToolboxItem(False)>
...
#Region " Component Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(AccessLogin))
            ...
            Me.Lbl_Header.Text = "       Access Login"
...
#End Region
        ...
        End Sub
        Private Sub AccessLogin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            FormTitle = "Access Login"
            clsFeature.SizeLock(SizeLock, ParentForm, FormTitle, Me)
            If ucAccessSetting Is Nothing Then ucAccessSetting = New UIForm.AccessSetting
            ucAccessSetting.SettingFile("Load")
            ucAccessSetting.Dispose()
            Chkb_Rember.Checked = My.Settings.Chkb_Rember
            If Chkb_Rember.Checked = True Then
                Txt_Username.Text = My.Settings.Txt_Username
                Txt_Password.Text = My.Settings.Txt_Password
            End If
        End Sub
        ...
        Private Sub Btn_Setting_Click(sender As Object, e As EventArgs) Handles Btn_Setting.Click
            If ucAccessSetting Is Nothing Then ucAccessSetting = New UIForm.AccessSetting
            If frmAccessSetting Is Nothing Then
                frmAccessSetting = New UIForm.DialogBox
                ucAccessSetting.SizeLock = True
                frmAccessSetting.Controls.Add(ucAccessSetting)
        ...
        Private Sub Btn_MSSQL_Login_Click(sender As Object, e As EventArgs) Handles Btn_MSSQL_Login.Click
            ucMenuStyle.TStrpMItm_MSSQL.PerformClick()
        End Sub
        Private Sub AccessLogin_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
            ucAccessLogin = Nothing
            frmAccessLogin = Nothing
        End Sub
    End Class
End Namespace